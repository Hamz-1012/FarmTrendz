...
class Commodity:
    ...
    max_depth=6,                    # Moderate depth due to dataset size (~80 rows)
    min_samples_split=4,           # Slightly stricter splits
    min_samples_leaf=2,            # Avoid overly specific leaves
    max_features='sqrt',           # Helps with regularization even for small datasets
    max_leaf_nodes=20,             # Prevent excessive growth
    random_state=42
)
